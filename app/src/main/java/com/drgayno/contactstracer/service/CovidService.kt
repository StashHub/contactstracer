...
import com.drgayno.contactstracer.jobs.AutoRestartJob
...
import com.drgayno.contactstracer.ui.ShortcutsManager
import com.drgayno.contactstracer.bt.BluetoothRepository
import com.drgayno.contactstracer.ui.notifications.CovidNotificationManager
import com.drgayno.contactstracer.ui.notifications.wrapAsForegroundService
import com.drgayno.contactstracer.util.BatteryOptimization
...
class CovidService : Service() {
    ...
    override fun onTaskRemoved(rootIntent: Intent?) {
        ...
        if (BatteryOptimization.isMiUI()) {
            ContextCompat.startForegroundService(this, startService(this))
        }
    }
